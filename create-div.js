...
// データ入力
var data = [
  { id: 0, category: 'ttf',name: 'n0', icon: 'icon-ki.png', img: 'img-kid.png' },
  { id: 1, category: 'ttfl',name: 'n1', icon: 'icon-1.png', img: 'img-1.png' },
  { id: 2, category: 'arsk',name: 'n2', icon: 'icon-2.png', img: 'img-2.png' },
  { id: 3, category: 'arsk',name: 'n3', icon: 'icon-3.png', img: 'img-3.png' }
];
